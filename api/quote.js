...
export default async function handler(req, res) {
  ...
  const lead={ source:'getmylicenseback.org', tenant_id:BROKERIQ_TENANT_ID, lead_type:'dui_license', name, email, phone, message:[notes,detailLines].filter(Boolean).join('\n\n'), ...details };
